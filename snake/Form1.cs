...
namespace SnakeGame
{
    ...
    {
        private static int snakeBlock = 20;
        private static int snakeSpeed = 20;
        private int screenWidth = snakeBlock * 20;
        private int screenHeight = snakeBlock * 15;
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            Pen snakePen = new Pen(Color.Blue, 3);
            Brush snakeBrush = Brushes.Blue;
            Brush foodBrush = Brushes.Red;

            foreach (Point point in snakeList)
            {
                //canvas.DrawRectangle(snakePen, point.X, point.Y, snakeBlock, snakeBlock);
